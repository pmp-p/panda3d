...
then
 ...
 -DHAVE_IOS_TYPEDEFS=1 -DHAVE_TINYDISPLAY=1 -DHAVE_X11=1 \
 -DCMAKE_INSTALL_LIBDIR=lib -DBUILD_SHARED_LIBS=1 \
    \
...
then
    ...
    then
        ...
        ${SDKROOT}/wasisdk/bin/wasi-run $(pwd)/bin/pview.wasi -c -L -s ${BUILD_DIR}/out.bmp
    fi
